...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Conv_Conv_134/out0_0:out0 */
    attr.size[0] = 4;
    attr.size[1] = 16800;
    attr.size[2] = 1;
    attr.dim_num = 3;
    ...
    /* @attach_Concat_Concat_202/out0_1:out0 */
    attr.size[0] = 2;
    attr.size[1] = 16800;
    attr.size[2] = 1;
    attr.dim_num = 3;
    ...
    /* @attach_Concat_Concat_219/out0_2:out0 */
    attr.size[0] = 10;
    attr.size[1] = 16800;
    attr.size[2] = 1;
    attr.dim_num = 3;
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    node[0]->output.tensors[0] = norm_tensor[2];
    node[0]->output.tensors[1] = norm_tensor[0];
    node[0]->output.tensors[2] = norm_tensor[1];
