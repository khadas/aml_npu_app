...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /*-----------------------------------------
      ...
      in_shape  - [[640, 640, 3, 1]]
      out_shape - [[640, 640, 64, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[0], VSI_NN_OP_CONV_RELU, 3, 1, 3);
    ...
    /*-----------------------------------------
      ...
      name      - convolutionrelu
      operation - convolutionrelu
      in_shape  - [[640, 640, 64, 1]]
      out_shape - [[640, 640, 64, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[1], VSI_NN_OP_CONV_RELU, 3, 1, 1);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[640, 640, 64, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[2], VSI_NN_OP_CONV_RELU, 3, 1, 2);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[640, 640, 64, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[3], VSI_NN_OP_CONV_RELU, 3, 1, 4);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[640, 640, 64, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[4], VSI_NN_OP_CONV_RELU, 3, 1, 5);
    ...
    /*-----------------------------------------
      ...
      operation - convolutionrelu
      in_shape  - [[640, 640, 64, 1]]
      out_shape - [[640, 640, 3, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[5], VSI_NN_OP_CONV_RELU, 3, 1, 6);
